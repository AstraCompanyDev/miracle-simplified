...
const ContactForm = () => {
  ...
  const WORDPRESS_URL = "https://miracleregen.com";
  const FORM_ID = "276";
  const ANTISPAM_TOKEN = "f3d43e7b4d57a6f8f543195fa953c80f";
  ...
  const handleSubmit = async (e) => {
    ...
    fd.append("wpforms[token]", ANTISPAM_TOKEN);
    fd.append("wpforms[fields][0]", formData.name);
    fd.append("wpforms[fields][1]", formData.email);
    fd.append("wpforms[fields][4]", formData.phone);
    fd.append("wpforms[fields][3]", formData.option);
    fd.append("wpforms[fields][2]", formData.message);
        ...
        <div>
          ...
          <div className="relative">
            ...
            >
              ...
              <option value="Inquire about a Treatment">Inquire about a Treatment</option>
              <option value="Book Your FREE Discovery Call">Book Your FREE Discovery Call</option>
            </select>
